...
class Client
{
    ...
    /**
     * Response object for the last request
     *
     * @type Response
     */
    protected $response;
    ...
    /**
     * Returns the response for the last request or null if no request has been submitted yet
     *
    ...
    public function getUserDevices($userToken)
    {
        ...
        $retValue = $this->response->getDevices();
        if ($retValue === null) {
            $retValue = array();
        }
    ...
    {
        // send the message
        $this->doRequest(Request::API_MESSAGE, $request);

        // return the message receipt (if any), will return null otherwise
        return $this->response->getReceipt();
    }
    ...
    public function pollReceipt(Receipt $request)
    {
        ...
        $this->doRequest(Request::API_RECEIPT, $request);
        return $this->response;
    }
